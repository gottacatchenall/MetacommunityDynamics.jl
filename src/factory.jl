...
function factory(m::Model{SC,M,Spatial,D}, d::T, stoch::S) where {V<:Number,T<:Union{Diffusion{V},Vector{Diffusion{V}}},S<:Stochasticity,SC<:Union{Population,Community},M,D}
